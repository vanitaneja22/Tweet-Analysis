...
def load_api():
    ...
    consumer_key = 'wePRvBXCWprlm3mxYGapIS7aJ'
    consumer_secret = 'FmRAVqPmYqrOttdd2CWklviC1mkppuzKnokON8dGwBgFuomoQO'
    access_token = '2801658395-cdaTh2VEEcFzOmAUdCDfRd5v4TqjYb3JhyZeKI4'
    access_secret = 'ZZ13Z8rjqDdNz3aKvUGHsJx2Fs8bMtjIAK3RDOPonCgfm'
...
def tweet_search(api, query, max_tweets, max_id, since_id, geocode):
    ...
    while len(searched_tweets) < max_tweets:
        ...
        try:
            ...
            with open(r'C:\Users\Utkarsh\PycharmProjects\twitter\out.txt', "a+", encoding="utf-8") as f:
                f.write("Tweets "+str(i)+" "+tweets[0]+'\n\n')
                i=i+1
            f.close()
